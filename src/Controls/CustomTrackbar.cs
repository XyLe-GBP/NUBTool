...
namespace NUBTool.src.Controls
{
    public partial class CustomTrackBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Common.Generic.IsAudioStreamingReloaded) return;
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (isScrolling)
            {
                ...
                if (ShowLPCSamples)
                {
                    str = new($"Value: {Value}" + "\n" + $"Total Samples: {Common.Generic.AudioTotalSamples}" + "\n" + $"Current Samples: {FormAudio.FormAudioInstance.SampleLabel}", 128);
                }
                else
                {
